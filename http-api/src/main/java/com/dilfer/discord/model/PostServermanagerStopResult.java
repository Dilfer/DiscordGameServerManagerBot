...
public class PostServermanagerStopResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PostServermanagerStopResult stopServerResponse(StopServerResponse stopServerResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostServermanagerStopResult == false)
            return false;
        PostServermanagerStopResult other = (PostServermanagerStopResult) obj;
    ...
    @Override
    public PostServermanagerStopResult clone() {
        try {
            return (PostServermanagerStopResult) super.clone();
