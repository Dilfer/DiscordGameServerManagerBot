...
/**
 * Base exception for all service exceptions thrown by GameManager
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GameManagerException extends com.amazonaws.SdkBaseException implements BaseException {
    ...
    /**
     * Constructs a new GameManagerException with the specified error message.
     *
     * @param message
    ...
    @Override
    public GameManagerException sdkHttpMetadata(SdkErrorHttpMetadata sdkHttpMetadata) {
