...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/2dbnwftaad-2021-03-25T18:44:59Z/StopServerRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopServerRequest implements Serializable, Cloneable, StructuredPojo {
    ...
    public StopServerRequest game(String game) {
        setGame(game);
        return this;
    }
    ...
    public StopServerRequest guild(String guild) {
        setGuild(guild);
        return this;
    }
    ...
    public StopServerRequest clone() {
        try {
            return (StopServerRequest) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.dilfer.gamemanager.model.transform.StopServerRequestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
