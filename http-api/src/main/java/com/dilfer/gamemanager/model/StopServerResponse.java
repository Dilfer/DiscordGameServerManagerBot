...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/2dbnwftaad-2021-03-25T18:44:59Z/StopServerResponse"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopServerResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public StopServerResponse newState(String newState) {
    ...
    public StopServerResponse originalState(String originalState) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopServerResponse == false)
            return false;
        StopServerResponse other = (StopServerResponse) obj;
    ...
    public StopServerResponse clone() {
        try {
            return (StopServerResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.dilfer.gamemanager.model.transform.StopServerResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
